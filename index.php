                                        ...
                                        if ($featured): ?>
                                            ...
                                            if ($post_counter % 2 == 0): ?>
                                                <div class="col-lg-4">
                                                        ...
                                                        <div class="row g-4 align-items-center">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="features-content d-flex flex-column">
                                                                    ...
                                                                    <a href="detail-page.php?id=<?= $row['id_artikel'] ?>"
                                                                        class="h6">
                                                                        <?= $row['judul'] ?>
                                                                    </a>
                                                    ...
                                                    $post_counter++;
                                                    if ($post_counter % 2 == 0):
                                                        echo '</div></div>'; // Close the inner row and col-lg-4 div
                                                    endif;
                                        endif;
                                    endwhile;
                                    if ($post_counter % 2 != 0):
                                        echo '</div></div>'; // Close the last row if it's not closed
                                    endif;
                                    ?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-3 rounded border">
                                            <div class="col-lg-12">
                                                ...
                                                <ul class="nav nav-pills d-inline-flex text-center mb-4">
                                                    ...
                                                    <li class="nav-item mb-3">
                                                        <a class="d-flex py-2 bg-light rounded-pill me-2" href="kategori_home.php?id_kategori=' . $row['id_kategori'] . '&referer=index.php">
                                                            <span class="text-dark link-hover"
                                                                style="width: 90px;">' . $row['nama_kategori'] . '</span>
                                                        </a>
                                                    </li>
                ...
                <div class="row g-5">
                    <div class="col-lg-6 col-xl-3">
                        <div class="footer-item-1">
                            ...
                            <p class="text-secondary line-h">Email: <span
                                    class="text-white">andrean1329@gmail.com</span></p>
